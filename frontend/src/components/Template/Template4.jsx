      ...
      >
        ...
        >
          ...
          <h2 className="card-title1"
           style={{ fontSize: `${dynamicFontSize}px`, color: backgroundTextColour,  }} // Use a variable for font size
          >{name}</h2>
          ...
          >
            {phoneWork && (
              <div className="col-12 col-md-6 col-lg-4">
                ...
                <span style={{ fontSize: "1.2rem",color: backgroundBarTextIconColor, }}>Call</span>
              </div>
            )}
            ...
            {phoneMobile && (
              <div className="col-12 col-md-6 col-lg-4">
                ...
                <span style={{ fontSize: "1.2rem",color: backgroundBarTextIconColor, }}>Mobile</span>
              </div>
            )}
            ...
            {Mobile2 && (
              <div className="col-12 col-md-6 col-lg-4">
                ...
                <span style={{ fontSize: "1.2rem" ,color: backgroundBarTextIconColor,}}>Mobile2</span>
              </div>
            )}
            ...
            {Mobile3 && (
              <div className="col-12 col-md-6 col-lg-4">
                ...
                <span style={{ fontSize: "1.2rem",color: backgroundBarTextIconColor, }}>Mobile3</span>
              </div>
            )}
            ...
            {email && (
              <div className="col-12 col-md-6 col-lg-4">
                ...
                >
                  <FaEnvelope
                    className="contact-icon me-2"
                    style={{ minWidth: "20px", fontSize: "1.5rem", color: backgroundBarIconColor, }}
                  />
                </a>
                <span style={{ fontSize: "1.2rem",color: backgroundBarTextIconColor, }}>Email</span>
              </div>
            )}
            ...
            {email2 && (
              <div className="col-12 col-md-6 col-lg-4">
                ...
                <span style={{ fontSize: "1.2rem",color: backgroundBarTextIconColor, }}>Email2</span>
              </div>
            )}
            ...
            {email3 && (
              <div className="col-12 col-md-6 col-lg-4">
                ...
                <span style={{ fontSize: "1.2rem",color: backgroundBarTextIconColor, }}>Email3</span>
              </div>
            )}
            ...
            {website && (
              <div className="col-12 col-md-6 col-lg-4">
                ...
                <span style={{ fontSize: "1.2rem",color: backgroundBarTextIconColor, }}>Website</span>
              </div>
            )}
            ...
            {website2 && (
              <div className="col-12 col-md-6 col-lg-4">
                ...
                <span style={{ fontSize: "1.2rem",color: backgroundBarTextIconColor, }}>Website2</span>
              </div>
            )}
            ...
            {website3 && (
              <div className="col-12 col-md-6 col-lg-4">
                ...
                <span style={{ fontSize: "1.2rem",color: backgroundBarTextIconColor, }}>Website3</span>
              </div>
            )}
            ...
            {address && (
              <div className="col-12 col-md-6 col-lg-4">
                ...
                <span style={{ fontSize: "1.2rem",color: backgroundBarTextIconColor, }}>Address</span>
              </div>
            )}
            ...
            {address2 && (
              <div className="col-12 col-md-6 col-lg-4">
                ...
                <span style={{ fontSize: "1.2rem",color: backgroundBarTextIconColor, }}>Address2</span>
              </div>
            )}
          </div>
