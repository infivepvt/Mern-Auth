...
const Template58 = ({
  ...
  return (
    ...
    >
      <div
        className="card custom-card58 shadow-lg"
        style={{
      ...
      >
        ...
        >
          <h2
            ...
            style={{ fontSize: `${dynamicFontSize}px`,fontFamily: '"Dancing Script", sans-serif' }} // Use a variable for font size
          >
            {name}
          </h2>
          <p
