...
const Template211 = ({
    ...
    >
      ...
      >
        ...
        <div className="card-body text-center">
          <h2 className="card-title" style={{ fontSize: `${dynamicFontSize}px`, color: backgroundTextColour,  }} // Use a variable for font size
          >{name}</h2>
          ...
          <div className="list-group mb-3 ">
            {phoneWork && (
              <button
                type="button"
                className="list-group-item211 d-flex align-items-center justify-content-between"
              ...
              >
                ...
                />
                <span className="text-center flex-grow-1 text-truncate custom-phone"
                style={{
 ...
 {youtube && (
          ...
          <button
            className="btn w-100 custom-save-button211"
