...
const Template211 = ({ contactDetails, selectedSocialMedia, socialLinks, selectedTemplate, whatsAppDetails, socialMediaUrl }) => {
    ...
    <div className={`container d-flex justify-content-center mt-5 template-${selectedTemplate}`}>
      <div className="card custom-card shadow-lg">
        ...
        <div className="card-body text-center">
          ...
          <button className="btn w-100 custom-save-button211" onClick={handleSaveToContacts}>
