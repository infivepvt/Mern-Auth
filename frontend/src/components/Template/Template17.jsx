...
const Template17 = ({
  ...
  return (
    ...
    >
      <div
        className="card custom-card17 shadow-lg"
        style={{
      ...
      >
        ...
        >
          ...
          <div className="profile-picture" style={{ marginTop: "20px", }}>
                ...
                <div style={{
                  ...
                  <button
                    ...
                    style={{
                      ...
                      width: "55px", // Set equal width and height
                      height: "55px", // Set equal width and height
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
