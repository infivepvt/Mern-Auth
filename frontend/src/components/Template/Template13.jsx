...
const Template13 = ({
  ...
  return (
    <div className={`card-container13 text-center template-${selectedTemplate}`}
      style={{
    ...
    >
      {/* Profile Header */}
      <div
        className="profile-header13"
        style={{ color: backgroundTextColour, height: "110px" }}
      >
        <img
          src={profileImage}
          alt={name}         
...
>
  ...
  <div
      ...
      >
        <div
          className="profile-contact-icons13"
          style={{
            display: "grid",
            ...
            <div style={{
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: "10px", // Makes the button circular
              ...
              <p style={{ marginTop: "5px", fontSize: "0.8rem", color: backgroundBarTextIconColor, textAlign: "center", width: "90px" }}>Mobile Number</p>
            </div>
          )}
          {phoneMobile && (
            <div style={{
      ...
      <div className="d-flex flex-wrap justify-content-center"
        ...
        >
          ...
          {currentSocialLinks.map((link) => (
            ...
            <a href={link.url} target="_blank" rel="noopener noreferrer" className="m-1">
                <SocialIcon url={link.url} network={link.platform.name.toLowerCase()} style={{ height: 55, width: 55 }} />
            </a>
            <span style={{ fontSize: "14px", marginTop: "5px" }}>{link.platform.name}</span>
        </div>
          ))}
        </div>
