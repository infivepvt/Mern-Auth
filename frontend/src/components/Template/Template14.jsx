...
const Template14 = ({
  ...
  return (
    <div className={`card-container14 text-center template-${selectedTemplate}`}
      style={{
    ...
    >
      ...
      >
        ...
        {/* Profile Header */}
        <div className="profile-header14" style={{ marginTop: "-30px" }}>
          <img
            src={profileImage}
            alt={name}
        ...
        <button className=" custom-save-button14" onClick={handleSaveToContacts}>
        ...
        >
          ...
          {phoneWork && (
            ...
            >
              ...
              />
              <span
                className="text-center flex-grow-1 text-truncate "
                style={{
      ...
      <div style={{ height: "20px", backgroundColor: backgroundColour, marginTop: "0", }}></div>
