...
const Template9 = ({
  ...
  return (
    ...
    >
      ...
      <div className="profile-contact-icons9">
            {phoneWork && (
                          <button
                            type="button"
      ...
      <div className="about-section" 
        ...
        <h5
        style={{ color: backgroundTextColour,  }} 
        >About Us</h5>
        <p>{about}</p>
      </div>
        ...
        <div>
          {currentSocialLinks.map((link) => (
            <a
              ...
              className={`social-media-button ${link.platform.name.toLowerCase()}`}
              style={{
                backgroundColor: backgroundBarColor, // Bar Background color----##################################################################################################
              }} 
            >
