...
const Template73 = ({
  ...
  return (
    ...
    >
      <div
        className="card custom-card73 shadow-lg"
        style={{
          backgroundColor: backgroundColour, // Background color----##################################################################################################
        }}
      >
        <div
          className="card-header custom-header73 text-center"
          style={{
        ...
        >
          ...
          <button
            className="btn w-100 custom-save-button73"
          ...
          <div className="d-flex flex-wrap justify-content-center" style={{backgroundColor:'#ffffff',borderWidth:'1px',borderRadius:'10px'}}>
