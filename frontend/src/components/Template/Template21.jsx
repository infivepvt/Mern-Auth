...
const Template21 = ({
  ...
  return (
    <div className={`card-container21 text-center template-${selectedTemplate}`}
      style={{
    ...
    >
      {/* Profile Header */}
      <div
        className="profile-header21"
        style={{ color: backgroundTextColour, height: "160px" }}
      >
        <img
          src={profileImage}
          alt={name}
