...
const Template12 = ({
  ...
  return (
    <div className={`card-container12 text-center template-${selectedTemplate}`}
      style={{
    ...
    >
      ...
      >
        ...
        {/* Profile Header */}
        <div className="profile-header12" >
          <img
            src={profileImage}
            alt={name}
        ...
        <p
          ...
          style={{
            ...
            whiteSpace: "normal", // Allow text wrapping
            wordWrap: "break-word", // Break long words if necessary
            fontSize: "23px", // Set a readable font size
     ...
     {/* Contact Icons */}
     <div className="profile-contact-icons12" style={{
    backgroundColor: "white",
    marginTop: "0",
    display: "flex", // Use flexbox
    justifyContent: "center", // Center horizontally
    alignItems: "center", // Center vertically
    gap: "10px", // Space between buttons (optional)
  }}>
        {phoneWork && (
          <button
            type="button"
        ...
        {phoneMobile && (
          <button
            ...
            style={{
              backgroundColor: backgroundBarColor, // Bar Background color
              borderRadius: "10px", // Makes the button circulary
              width: "50px", // Set equal width and height
              height: "50px", // Set equal width and height
              display: "flex",
              alignItems: "center",
      ...
      <div style={{height:"20px",backgroundColor: backgroundBarColor,marginTop:"0",}}></div>
      ...
      {/* About Section */}
      <div className="about-section" style={{ backgroundColor: backgroundColour,}}>
        <h5>About Us</h5>
        <p>{about}</p>
      </div>
