      ...
      style={{
        ...
        <h2 className="card-title40"
          ...
          <img
            src={logo}
            alt="Company Logo"
            className="custom-logo1"
            style={{ width: `${logoSize}%`, opacity: logoOpacity / 100 }}
          />
          <hr class="custom-line" />
