...
useEffect(() => {
  ...
  return (
    <div className={`profile-card67 template-${selectedTemplate}`}
    style={{
    ...
    >
      <div className="profile-banner">
        ...
        <div className="profile-info67">
          <h2  style={{ fontSize: `${dynamicFontSize}px`, color: backgroundTextColour,  }}>{name}</h2>
          <p style={{
      ...
      <div className="profile-contact-icons67">
        <button className="subscribe-button">
          <FaBell className="ringing-icon" />
          Subscribe
        </button>
      </div>
          ...
          {currentSocialLinks.map((link) => (
            ...
            >
              <SocialIcon
                ...
                style={{ height: 50, width: 50, color: backgroundBarIconColor }} // Set icon size
              />
      ...
      <button
        className="btn h-100 custom-save-button social-media-button"
