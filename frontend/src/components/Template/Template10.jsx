...
const Template10 = ({
  ...
  return (
    ...
    >
      <div
        className="card custom-card10 shadow-lg"
        style={{
          backgroundColor: backgroundColour, // Background color----##################################################################################################
        }}
      >
        <div
          className="custom-header text-center"
        >

          <div className="profile-picture">
            <img src={profileImage} alt={name} className="rounded-circle" style={{ marginTop: "60px" }} />
          </div>
        </div>
        <br />
        <br />
        ...
        >
          <h2
            ...
            style={{
              ...
              marginBottom: "10px", // Adds space between h2 and p
            }}
          >
            {name}
          </h2>
          <div class="horizontal-line" style={{ width : "50px"
    }}></div>
          <p
            style={{
